...
SRCS += $(addprefix $(d), \
	...
	latency.cc configuration.cc beehive_lib.cc transport.cc dkudptransport.cc udptransport.cc simtransport.cc)
...
LIB-dkudptransport := $(o)beehive_lib.o $(o)dkudptransport.o $(LIB-transport)
