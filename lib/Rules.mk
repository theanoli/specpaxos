...
SRCS += $(addprefix $(d), \
	...
	latency.cc configuration.cc beehive_lib.cc transport.cc udptransport.cc simtransport.cc)
...
LIB-udptransport := $(o)beehive_lib.o $(o)udptransport.o $(LIB-transport)
